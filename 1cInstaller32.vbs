...
Const DistrFolder = "C:\Program Files (x86)\1cv8" rem //укажем путь для установки
...
Const InstallUID= "{AF996617-CB3A-4670-8AE9-C36FFDD3C41F}"  rem //это значение нужно взять из дистрибутива из файла setup.ini - ProductCode
installOrUninstall InstallUID, DistrFolder + "8.3.15.1747\1CEnterprise 8_xp.msi", "1049.mst", "adminstallrestart.mst", requiredInstall   rem //8.2.16.368 укажем название папки, в которую будет установлена платформа
Sub installOrUninstall (ByVal productCode, ByVal msiPackage, ByVal mstTransform, ByVal mstinstall, ByVal requiredAction)
productCode = "{AF996617-CB3A-4670-8AE9-C36FFDD3C41F}"  rem //это значение нужно взять из дистрибутива из файла setup.ini - ProductCode
msiPackage = "\\192.168.17.7\netlogon\1c_new_platphorma\32.8.3.15.1747\1CEnterprise 8_xp.msi"   rem //полный путь к дистрибутиву, а именно к файлу 1CEnterprise 8.2.msi
